...
import com.mark.likemovies.ui.home.HomeViewModel
...
class FilterResultsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_filter_results)
          userDetails
            this.getSharedPreferences(  Constants.USER_DETAILS_SharedPrefs, Context.MODE_PRIVATE)
        ...
        lifecycleScope.launch(Dispatchers.Main) {
            try {
                var likeReactResponse =
                    viewModel.getSuggestion(user_id = "35", "1", "drama", "usa", "2000", "2001")
